...
import com.matheusamiranda.cursomc.domain.*;
import com.matheusamiranda.cursomc.domain.enums.EstadoPagamento;
import com.matheusamiranda.cursomc.domain.enums.TipoCliente;
import com.matheusamiranda.cursomc.repositories.*;
...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Categoria cat4 = new Categoria(4, "Eletrônicos");
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "matheusamiranda@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);

        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Endereco e1 = new Endereco(null, "Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
